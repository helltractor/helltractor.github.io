import{_ as d}from"./ValaxyMain.vue_vue_type_script_setup_true_lang.DX4ms2Zs.js";import"./chunks/nprogress.CUspbDhs.js";import{d as h,u as _,a as f}from"./chunks/vue-router.CbKQsBJE.js";import{a2 as b,a9 as s,W as g,a3 as w,a8 as e,a7 as n,aa as a,_ as k}from"./framework.KJZaO2aS.js";import"./app.BuMR6GMo.js";import"./chunks/dayjs.B_GB4L9t.js";import"./chunks/pinia.B86ssRKG.js";import"./chunks/vue-i18n.BCIiF0EM.js";/* empty css                    */import"./content.ByglB6Gy.js";import"./router.-rV2tM5K.js";const x=h("/posts/calculation/set-win",async i=>JSON.parse('{"title":"Wannier90.win 文件设置","description":"","frontmatter":{"title":"Wannier90.win 文件设置","date":"2024-06-21","categories":"Calculation","tags":["Wannier90"]},"headers":[],"relativePath":"pages/posts/calculation/set-win.md","lastUpdated":null}'),{lazy:(i,t)=>i.name===t.name}),R={__name:"set-win",setup(i,{expose:t}){const{data:r}=x(),c=f(),u=_(),p=Object.assign(u.meta.frontmatter||{},r.value?.frontmatter||{});return c.currentRoute.value.data=r.value,k("valaxy:frontmatter",p),globalThis.$frontmatter=p,t({frontmatter:{title:"Wannier90.win 文件设置",date:"2024-06-21",categories:"Calculation",tags:["Wannier90"]}}),(l,o)=>{const m=d;return w(),b(m,{frontmatter:g(p)},{"main-content-md":s(()=>o[0]||(o[0]=[n("h2",{id:"example",tabindex:"-1"},[a("Example "),n("a",{class:"header-anchor",href:"#example","aria-label":'Permalink to "Example"'},"​")],-1),n("div",{class:"language-txt max-h-300px"},[n("button",{title:"Copy code",class:"copy"}),n("span",{class:"lang"},"txt"),n("pre",{class:"shiki shiki-themes github-light github-dark vp-code"},[n("code",{"v-pre":""},[n("span",{class:"line"},[n("span",null,"num_bands =           # 设置能带数量")]),a(`
